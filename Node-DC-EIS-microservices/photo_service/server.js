...
'use strict';
var serviceName = "Photo Information";
var express = require('express');
var mongoose = require('mongoose');
var bodyParser = require('body-parser');
var appConfig = require('./config/configuration');
var photoCtrl = require('./controllers/photo_controller');
var app = express();
const os = require('os');
...
app.get('/photos',                 photoCtrl.findAll);

//add new photo record
app.post('/photos',                photoCtrl.newPhoto);

//get photo record by employee ID
app.get('/photos/:employee_id',    photoCtrl.getPhotoByEmployeeId);

//delete photo record by employee ID
app.delete('/photos/:employee_id', photoCtrl.deleteByEmployeeId);
...
app.get('/getcpuinfo', function collectMemInfo(req, res) {
  var hwInfo = {};
  var swInfo = {};
  var versionInfo = {};
  var systemInfo = {};
