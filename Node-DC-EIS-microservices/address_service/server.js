...
var addressCtrl = require('./controllers/address_controller');
var app = express();
const os = require('os');
...
app.get('/addresses', addressCtrl.findAll);

//get an address by zipcode
app.get('/addresses/zipcode', addressCtrl.findByZipcode);

//get an address by employee ID
app.get('/addresses/:employee_id', addressCtrl.getAddressByEmployeeId);

//add new address record
app.post('/addresses', addressCtrl.newAddress);

//delete a record based on employee ID
app.delete('/addresses/:employee_id', addressCtrl.deleteByEmployeeId);
